              ...
              >
                ...
                {value === "nsp" || !value ? (
                  <span className="inline-flex w-fit items-center gap-2 rounded-lg bg-surface px-3 py-1.5 text-[13.5px] font-medium text-ink-500">
                    ...
                    {value ? ANSWER_LABEL[value][locale] : NO_ANSWER[locale]}
                  </span>
                ) : (
