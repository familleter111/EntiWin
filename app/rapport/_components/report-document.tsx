...
import {
  CriticalityChip,
  StatusChip,
} from "@/app/analyse/_components/requirement-chips";
import { useWizard } from "@/app/analyse/_components/wizard-store";
import { DEMO_FILES } from "@/app/analyse/_lib/documents";
import {
  complianceScore,
  topRecommendations,
} from "@/app/analyse/_lib/recommendations";
import {
  REQUIREMENTS,
  requirementStats,
} from "@/app/analyse/_lib/requirements";
...
function Letterhead({ compact = false }: { compact?: boolean }) {
  return (
    <header className="flex items-center gap-3">
      <Logo className={compact ? "h-8 w-8 shrink-0" : "h-11 w-11 shrink-0"} />
      <span
